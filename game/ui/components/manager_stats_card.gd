...
func setup(manager: Dictionary) -> void:
	...
	if panel_texture == null:
		...
		style.bg_color = Color(0.025, 0.10, 0.15, 0.94)
		style.border_color = Color(0.08, 0.58, 0.75, 0.9)
	...
	box.offset_left = 18; box.offset_right = -18; box.offset_top = 22; box.offset_bottom = -22
	add_child(box)
